...
const groups = [{
		...
		items: [{
			...
			},
			{
				...
				background: 'white',
				type: type[1],
				about: "A popular general-purpose scripting language that is especially suited to web development"
			},
		]
	},
	{
		...
		items: [{
			...
			},
			{
				...
				background: 'white',
				type: type[23],
				about: "A semantic personal publishing platform with a focus on aesthetics, web standards, and usability"
			},
			{
				name: 'Contentful',
				icon: 'contentful.png',
