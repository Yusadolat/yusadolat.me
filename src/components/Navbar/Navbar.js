            ...
            <ul className={`Navbar__nav ${menuIsOpen ? "open" : ""}`}>
              ...
              <li className="Navbar__item">
                <Link
                  ...
                  className={`Navbar__link ${
                    this.props.activePage === "Blog" ? "active" : ""
                  }`}
                  to="/blog"
                >
                  <svg
              ...
              <li className="Navbar__item">
                <Link
                  ...
                  className={`Navbar__link ${
                    this.props.activePage === "About" ? "active" : ""
                  }`}
                  to="/about"
                >
                  <svg
              ...
              <li className="Navbar__item">
                <Link
                  ...
                  className={`Navbar__link ${
                    this.props.activePage === "Portfolio" ? "active" : ""
                  }`}
                  to="/portfolio"
                >
                  <svg
              ...
              <li className="Navbar__item">
                <Link
                  ...
                  className={`Navbar__link ${
                    this.props.activePage === "Contact" ? "active" : ""
                  }`}
                  to="/contact"
                >
                  <svg
