...
export default props => (
	<div className='AuthorPostFooter'>
		...
		<div className="AuthorPostFooter__body">
			...
			<p className="AuthorPostFooter__about">Awaed Winning Full Stack Developer. Devops Engineer focus on AWS and Google Cloud. I also like to develop BOT, you can see the ones I created in my <Link to="/portfolio">portfolio</Link>.</p>
